...
\begin{figure*}
    ...
    bottom panel shows residuals (pull) relative to the maximum a posteriori
    model, where the factor $\beta_d$ has been included in the calculation of
    the residuals.}
    %
    \label{fig:corner_LC}
\end{figure*}
...
converged chains, we find that 98 ($> 85\%$ of the sample) have marginalized, 1-D
