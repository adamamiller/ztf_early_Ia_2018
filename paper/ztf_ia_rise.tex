...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{./figures/ZTF18abgmcmv_corner.pdf}
    %
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{./figures/ZTF18abukmty_corner.pdf}
    %
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{./figures/ZTF18aazabmh_corner.pdf}
    %
...
and flag those that produce unreliable fits to the data. We use this subset
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{./figures/ZTF18abgmcmv_model_lc.pdf}
    %
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{./figures/ZTF18abukmty_model_lc.pdf}
    %
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{./figures/ZTF18aazabmh_model_lc.pdf}
    %
...
population-level correlations between the model parameters. We can also
search for correlations between the model parameters and redshift, which, if
present, could reveal cosmic evolution of SNe Ia progenitors. We show
correlations between $t_\mathrm{rise}$, $\alpha_g$, $\alpha_r$, and $z$ in
Figure ~\ref{fig:model_parameters}. The top right panel of
Figure~\ref{fig:model_parameters} shows an extremely tight correlation
between $\alpha_g$ and $\alpha_r$, so we do not show the correlation between
$\alpha_r$ and $z$ or between $\alpha_g$ and \trise, as this information is
...
Figure~\ref{fig:model_parameters} shows \trise, however, the model provides
constraints solely on \tfl. \tfl\ is measured relative to \tbmax, the time of
maximum light in the $B$-band, which itself has some measurement uncertainty.
\trise\ accounts for the uncertainties on both \tfl\ and \tbmax. To estimate
\trise, we use a Gaussian kernel density estimation (KDE) to approximate the
1-D marginalized probability density function (PDF) for \tfl. The width of
the kernel is determined via cross validation and the KDE is implemented with
...
\subsection{Correlations with Redshift}
