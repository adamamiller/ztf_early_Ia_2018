...
In the most extreme cases, as shown in Figure~\ref{fig:no_obs}, large gaps in
the light curve make it nearly impossible to constrain the model parameters.
For these cases, the model posteriors are essentially identical to the priors.
