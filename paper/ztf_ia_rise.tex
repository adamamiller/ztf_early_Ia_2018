...
\begin{figure*}
    ...
    \S\ref{sec:qa}), dark blue circles show reliable fits where the host
...
index in either filter strongly predicts the value in the other filter.
...
\begin{figure}
    ...
    %
    \caption{Same as the lower left panel of
