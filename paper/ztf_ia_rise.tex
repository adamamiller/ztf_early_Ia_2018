...
amplitude of the SN.\footnote{We do this separately in the \gztf\ and \rztf\ filters. In practice, if a single night of observation includes any observations with $f \le 0.4 f_\mathrm{max}$ we keep all the observations from that night.} This choice, 40\% instead of 30\% or 50\%, does affect the final inference that is made for individual SNe as discussed in further detail in \S\ref{sec:systematics}.
