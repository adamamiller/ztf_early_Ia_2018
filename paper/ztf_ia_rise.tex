...
\received{2020 January 17}
\revised{2020 August 4}
\accepted{2020 August 6}
...
of the WD. Here, we present a comprehensive analysis of a large, unique data
set of 127 SNe\,Ia with exquisite coverage by the Zwicky Transient Facility
(ZTF). High-cadence (six observations per night) ZTF observations allow us to
...
normal SNe\,Ia, we find that the mean power-law index is consistent with 2 in
the \rztf-band ($\alpha_r = 2.01\pm0.02$), as expected in the expanding
fireball model. There are, however, individual SNe that are clearly
inconsistent with $\alpha_r=2$. We estimate a mean rise time of 18.9\,d (with
a range extending from $\sim$15 to 22\,d), though this is subject to the
...
time of 21.7\,d (with a range from $\sim$18 to 23\,d). The sample includes a
handful of rare and peculiar SNe\,Ia. Finally, we conclude with a discussion
of lessons learned from the ZTF sample that can eventually be applied to
...
As outlined in the \nameref{sec:intro}, there are broadly two different
