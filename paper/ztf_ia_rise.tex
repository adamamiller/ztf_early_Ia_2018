...
weighted sample mean is XXX for the full sample of normal SNe Ia, which
increases to XXX and XXX for the reliable and reliable-$z_\mathrm{host}$
subgroups, respectively. The scatter in $\alpha_r$ is XXX, XXX, and XXX for
the full, reliable, and reliable-$z_\mathrm{host}$ subsamples, respectively.
As noted below, there is an extremely tight correlation between $\alpha_g$ and
$\alpha_r$, and thus we do not show the individual PDFs for $\alpha_r$.
...
\subsection{Population correlations}
...
cosmic evolution of SNe Ia progenitors. \todo{move or remove this paragraph}
...
between $\alpha_g$ and $\alpha_r$ (top right panel). 
