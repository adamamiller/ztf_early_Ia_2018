...
typical characteristics of a \textit{normal} SN Ia. We define normal as those
SNe that are suitable for inclusion cosmographic measurements, which can be
...
Figure~\ref{fig:rise_time}, SNe with reliable model parameters (see
Appendix~\ref{sec:qa}) and known host galaxy redshifts (hereafter the
