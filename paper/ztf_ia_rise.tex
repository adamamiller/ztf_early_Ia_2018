...
Telescope observations. \todo{Gonzalez-Gaitan find long rise times for fast decliners, and short rise times for slow decliners}
...
\citealt{Kromer16,Shappee18,Noebauer17,Miller18,Shappee19}) to appeal to
...
\begin{figure}
    ...
    (middle panel), and thin grey lines show SNe from the unreliable group
